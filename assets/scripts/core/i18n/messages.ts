...
export const DEFAULT_MESSAGES: Record<LanguageCode, LocalizationDictionary> = {
    zh: {
        ...
        'item.freeze_enemies.name': '冰封天地',
        'item.freeze_enemies.description': '极寒之力弥散战场，所有敌人被冰封原地，无法行动10秒。',
        'item.freeze_enemies.short': '冻结所有敌人10秒',
        'item.upgrade_buildings.name': '天工开物',
        'item.upgrade_buildings.description': '神匠之力降临，所有防御塔瞬间进化，全部提升1级。',
        'item.upgrade_buildings.short': '所有防御塔升1级',
        'item.bonus_coins.name': '天降横财',
        'item.bonus_coins.description': '财神降临，立刻获得200金币，充实你的战争储备。',
        'item.bonus_coins.short': '立即+200金币',
        'item.hero_invincible.name': '金身不坏',
        'item.hero_invincible.description': '金光护体，英雄获得30秒无敌状态，刀枪不入，百毒不侵。',
        'item.hero_invincible.short': '英雄无敌30秒',
    ...
    en: {
        ...
        'item.freeze_enemies.name': 'Frozen World',
        'item.freeze_enemies.description':
            'A wave of frost sweeps the battlefield, freezing all enemies in place for 10 seconds.',
        'item.freeze_enemies.short': 'Freeze all enemies for 10s',
        'item.upgrade_buildings.name': 'Divine Engineering',
        'item.upgrade_buildings.description':
            'Divine craftsmanship descends — all defense towers instantly evolve, gaining 1 level.',
        'item.upgrade_buildings.short': 'All towers +1 level',
        'item.bonus_coins.name': 'Windfall',
        'item.bonus_coins.description':
            'Fortune smiles upon you — instantly receive 200 gold to bolster your war chest.',
        'item.bonus_coins.short': 'Instantly +200 gold',
        'item.hero_invincible.name': 'Golden Shield',
        'item.hero_invincible.description':
            'A golden aura envelops the hero, granting 30 seconds of complete invincibility.',
        'item.hero_invincible.short': 'Hero invincible for 30s',
