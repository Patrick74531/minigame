...
export const DEFAULT_MESSAGES: Record<LanguageCode, LocalizationDictionary> = {
    zh: {
        ...
        'item.upgrade_buildings.description': '神匠之力降临，所有建筑瞬间进化，全部提升1级。',
        'item.upgrade_buildings.short': '所有建筑升1级',
    ...
    en: {
        ...
        'item.upgrade_buildings.description':
            'Divine craftsmanship descends — all buildings instantly evolve, gaining 1 level.',
        'item.upgrade_buildings.short': 'All buildings +1 level',
