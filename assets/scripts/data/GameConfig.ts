    ...
    WEAPON_SYSTEM: {
        ...
        WEAPONS: {
            machine_gun: {
                ...
                iconColor: '#FF4500',
                iconPath: 'icon/gun',
                // L1→L5 DPS: 50→176 (3.5×). AttackInterval only drops 0.12→0.07 (not 0.04).
                levels: [
                    { damage: 6,  attackInterval: 0.12, range: 4.8, projectileSpeed: 28, spread: 4 },
                    { damage: 8,  attackInterval: 0.11, range: 5.0, projectileSpeed: 30, spread: 5 },
                    { damage: 10, attackInterval: 0.10, range: 5.2, projectileSpeed: 32, spread: 6 },
                    { damage: 13, attackInterval: 0.09, range: 5.4, projectileSpeed: 34, spread: 7 },
                    { damage: 16, attackInterval: 0.07, range: 5.6, projectileSpeed: 36, spread: 8 },
                ],
            },
            flamethrower: {
                id: 'flamethrower',
                ...
                iconColor: '#8B0000',
                iconPath: 'icon/fire',
                // L1→L5 DPS: 60→200 (3.3×). Interval 0.3→0.2.
                levels: [
                    { damage: 18, attackInterval: 0.30, range: 3.4, projectileSpeed: 10, gravity: 8, burnDuration: 1.5 },
                    { damage: 24, attackInterval: 0.28, range: 3.8, projectileSpeed: 11, gravity: 8, burnDuration: 1.8 },
                    { damage: 31, attackInterval: 0.26, range: 4.2, projectileSpeed: 12, gravity: 7, burnDuration: 2.1 },
                    { damage: 38, attackInterval: 0.23, range: 4.7, projectileSpeed: 13, gravity: 7, burnDuration: 2.4 },
                    { damage: 47, attackInterval: 0.20, range: 5.2, projectileSpeed: 14, gravity: 6, burnDuration: 2.8 },
                ],
            },
            cannon: {
                id: 'cannon',
                ...
                // L1→L5 DPS: 42→98 (2.3×, cannon already strong via AOE). Interval 1.2→0.9.
                levels: [
                    { damage: 50,  attackInterval: 1.2, range: 6.9, projectileSpeed: 18, explosionRadius: 1.5, spinSpeed: 15 },
                    { damage: 65,  attackInterval: 1.1, range: 7.2, projectileSpeed: 19, explosionRadius: 1.8, spinSpeed: 18 },
                    { damage: 82,  attackInterval: 1.0, range: 7.5, projectileSpeed: 20, explosionRadius: 2.1, spinSpeed: 20 },
                    { damage: 100, attackInterval: 0.95, range: 7.8, projectileSpeed: 21, explosionRadius: 2.5, spinSpeed: 22 },
                    { damage: 120, attackInterval: 0.90, range: 8.1, projectileSpeed: 22, explosionRadius: 3.0, spinSpeed: 25 },
                ],
            },
            glitch_wave: {
                id: 'glitch_wave',
                ...
                // L1→L5 DPS: 27.5→100 (3.6×). Interval 0.4→0.28. Damage ÷5 of original (high-freq).
                levels: [
                    { damage: 11,   attackInterval: 0.40, range: 5.4, waveSpeed: 8,  waveRadius: 4,   slowPercent: 0.28, slowDuration: 1.6 },
                    { damage: 13.5, attackInterval: 0.37, range: 5.9, waveSpeed: 9,  waveRadius: 4.5, slowPercent: 0.34, slowDuration: 1.9 },
                    { damage: 16.5, attackInterval: 0.35, range: 6.4, waveSpeed: 10, waveRadius: 5,   slowPercent: 0.40, slowDuration: 2.2 },
                    { damage: 21,   attackInterval: 0.33, range: 6.9, waveSpeed: 11, waveRadius: 5.5, slowPercent: 0.46, slowDuration: 2.5 },
                    { damage: 25,   attackInterval: 0.28, range: 7.4, waveSpeed: 12, waveRadius: 6,   slowPercent: 0.52, slowDuration: 2.8 },
                ],
            },
